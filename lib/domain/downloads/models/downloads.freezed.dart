...
mixin _$Downloads {
  ...
  String? get PostPath => throw _privateConstructorUsedError;
  @JsonKey(name: "title")
...
abstract class $DownloadsCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "poster_path") String? PostPath,
...
class _$DownloadsCopyWithImpl<$Res, $Val extends Downloads>
  ...
  @override
  $Res call({
    Object? PostPath = freezed,
    Object? title = freezed,
  }) {
    return _then(_value.copyWith(
      PostPath: freezed == PostPath
          ? _value.PostPath
          : PostPath // ignore: cast_nullable_to_non_nullable
              as String?,
      title: freezed == title
          ? _value.title
...
class _$_Downloads implements _Downloads {
  const _$_Downloads(
      {@JsonKey(name: "poster_path") required this.PostPath,
  ...
  @override
  String toString() {
    return 'Downloads(PostPath: $PostPath, title: $title)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.PostPath, PostPath) ||
                other.PostPath == PostPath) &&
            (identical(other.title, title) || other.title == title));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, PostPath, title);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
      {@JsonKey(name: "poster_path") required final String? PostPath,
